...
3. Jupyter のホーム ページの**Users/DP100** フォルダーで、**09A - Reviewing Automated Machine Learning Explanations.ipynb** Notebook を開きます。次に、Notebook 内の注意事項を読み、各コード セルを順番に実行します。
